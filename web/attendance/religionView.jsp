		...
		<table border=0 cellspacing=1 cellpadding=0 id="ep"
			...
			<tr>
				<td class="tableHeader" colspan=4 nowrap><abc:i18n
						property="attendance.header.religion" />
					<fmt:message key="attendance.header.religion" /></td>
			</tr>
					...
					<table rules="all" align="center" width="70%" class="sofT">
						...
						<c:forEach items="${records}" var="record">
							<tr height=20 bgcolor="#F8F8F8">
								<td class="helpBod" nowrap>${record.religion}</td>
								...
								<td class="helpBod" nowrap><abc:i18n
									...
									href="religionForm.html?religionCode=${record.religion}"><fmt:message
			...
			<tr>
				<td colspan="2" align="center"><br> <abc:i18n
					...
					class="button" onclick="window.location='religionForm.html'"></input>
				</td>
			</tr>
