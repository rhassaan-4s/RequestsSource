	...
	<table width="90%" border="0" cellspacing="0" cellpadding="0"
		...
		<tr>
			<td><form:form method="POST" modelAttribute="loginUsersRequests"
					...
					<input type="hidden" id="errand" name="errand"
						value="${model.errand}" />
					...
					<div id="result">
						<table border=0 cellspacing=1 cellpadding=0 id="ep"
							...
							<tr id="head_1_ep">
								<c:if test="${model.requestType=='1' && errand!='true'}">
							...
							<tr id="btnPrint">
								...
								<c:choose>
									<c:when
										test="${model.request_date_from ==null || model.request_date_from==''}">
								...
								<c:choose>
									<c:when
										test="${model.request_date_to ==null || model.request_date_to==''}">
										<td class="formBodControl"><input type="text"
											class="calendar" class="MM_from_d" title="ccc"
											readonly="readonly" autocomplete="off" dir="ltr"
											name="request_date_to" id="request_date_to"
											value="${model.today}" /></td>
									</c:when>
									<c:when
										test="${model.request_date_to !=null || model.request_date_to!=''}">
										<td class="formBodControl"><input type="text"
							...
							<tr id="btnPrint">
								...
								<c:choose>
									...
									<c:when
										...
										<td class="formBodControl"><input type="text"
											...
											readonly="readonly" autocomplete="off" dir="ltr"
											name="exact_request_date_from" id="exact_request_date_from"
											value="${model.exact_request_date_from}" /></td>
									</c:when>
								</c:choose>
								<td nowrap class="formBodControl"><abc:i18n
										property="commons.caption.to" /> <fmt:message
								...
								<c:choose>
									<c:when
										test="${model.exact_request_date_to ==null || model.exact_request_date_to==''}">
										<td class="formBodControl"><input type="text"
											class="calendar" class="MM_from_d" title="ccc"
											readonly="readonly" autocomplete="off" dir="ltr"
									...
									<c:when
										...
										<td class="formBodControl"><input type="text"
											...
											readonly="readonly" autocomplete="off" dir="ltr"
											name="exact_request_date_to" id="exact_request_date_to"
											value="${model.exact_request_date_to}" /></td>
									</c:when>
								</c:choose>
								...
								<tr height=20 bgcolor="#F8F8F8">
									...
									<td nowrap><c:choose>
											<c:when
												...
												<a
													href="requestsApprovalForm.html?reqId=${record.id}&requestType=${model.requestType}&errand=${errand}">${record.requestNumber}</a>
											</c:when>
											<c:otherwise>
									...
									<c:choose>
										<c:when test="${model.requestType=='1'||model.requestType=='2'}">
											<td nowrap><_4s_:formatMiladiDate
											...
											<c:choose>
												<c:when test="${model.requestType=='2'}">
													<td nowrap>${record.vacCredit}</td>
												</c:when>
											</c:choose>
										</c:when>
										<c:when test="${model.requestType=='3'}">
											<td nowrap><_4s_:formatMiladiDate
									...
									<c:choose>
										<c:when test="${model.requestType=='1'}">
									...
									<c:choose>
										...
										<c:otherwise>
											<td id="btnPrint" nowrap><abc:i18n
												...
												href="requestsApprovalForm.html?reqId=${record.id}&requestType=${model.requestType}"><fmt:message
