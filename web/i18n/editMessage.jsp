...
<table style="padding-right: 10px">
	...
	<tr>
		<td class="tableHeader"><abc:i18n
				property="i18n.header.editMessage" /> <fmt:message
				key="i18n.header.editMessage" /></td>
		<td align="left"></td>
	</tr>
	<tr>
	...
	<tr>
		<td colspan="2"><form:form method="POST" modelAttribute="msg"
				action="/Requests/i18n/editMessage.html">

				<input type="hidden" size=20 maxlength=40 name="myKey"
					value="${myKey}" />
				...
				<table border=0 cellspacing=1 cellpadding=0 id="ep"
					...
					<tr id="head_1_ep">
						...
						<td nowrap colspan=1 align=left><img
							...
							border="0" alt="Required Information"
							title="Required Information" width=18 height=18><span
							class="bodySmallBold"> = <abc:i18n
									property="commons.caption.requiredInformation" />
								<fmt:message key="commons.caption.requiredInformation" /></span></td>
					</tr>
					<TR>
					...
					<tr>
						<td nowrap class="requiredInput"><abc:i18n
								property="i18n.caption.message" /> <fmt:message
								key="i18n.caption.message" /></td>
						<td><spring:bind path="msg.message">
					...
					<tr id="btn">
						<td colspan=5 align=center><abc:i18n
							...
							class="button" />&nbsp;&nbsp;&nbsp; <abc:i18n
								property="commons.button.close" /> <input type="button"
							name="close" value="<fmt:message key="commons.button.close"/>"
							class="button" onclick="self.close()" /></td>
