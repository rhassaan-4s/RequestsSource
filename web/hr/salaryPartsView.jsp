...
<table width="90%" border="0" cellspacing="0" cellpadding="0" style="padding-right:10px ">
   <form id="effectView" name="effectView" method="POST" action="<c:url value="/hr/salaryPartsView.html"/>">
			...
			<tr>
				<td colspan="8" class="helpTitle"><abc:i18n
					property="hr.header.salaryPartsView" /><fmt:message
					key="hr.header.salaryPartsView" /></td>
			</tr>
							   ...
							   <tr height=20 bgcolor="#F8F8F8">
								...
								<c:if test="${record.displayed_flag=='T'}">
								  ...
								  <td class="helpBod" nowrap><abc:i18n
									...
									href="salaryPartsForm.html?effectId=${record.id}"><fmt:message
		...
		<br>
			...
			<input type="button" value="<fmt:message key="commons.button.add"/>" name="add" class="button"	onclick="window.location='salaryPartsForm.html?displayed_flag=${displayed_flag}'"></input>
		</td>
	</tr>
	</c:if>		
