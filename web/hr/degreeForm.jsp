...
<table width="90%" border="0" cellspacing="0" cellpadding="0" style="padding-right:10px ">
   <form id="degreeForm" name="degreeForm" method="POST"	action="<c:url value="/hr/degreeForm.html"/>">
   
   <input type="hidden"  id="degreeId" name="degreeId" value="${degreeId}"/>
   <tr>
		<td colspan="2">
  	...
  	<table  align="center" width="66%" class="sofT" >
			<tr id="head_1_ep">
				<td class="helpTitle" colspan="2" nowrap><abc:i18n
					property="hr.header.addDegree" /><fmt:message
					key="hr.header.addDegree" /></td>
			</tr>
			
		    <tr>
		  
		  <c:set var="check"  value=""/>
		  <c:if test="${degreeId!=null && degreeId!=''}">
				...
				<td class="formBodControl">
					<spring:bind path="degree.degree">
		  ...
		  <tr>
		    <td nowrap class="formReq" width="30%">
								<abc:i18n property="hr.caption.degreeStart"/>
								<fmt:message key="hr.caption.degreeStart"/></td>
		
				<td  class="formBodControl">
					<spring:bind path="degree.start_">
			...
			<tr>
					  <td nowrap class="formReq" width="30%">
								<abc:i18n property="hr.caption.degreeEnd"/>
								<fmt:message key="hr.caption.degreeEnd"/></td>
		
				<td  class="formBodControl">
					<spring:bind path="degree.end_">
						  <input size="30"  type="text"	 name="${status.expression}" value="${status.value}"/> 			
					</spring:bind>
					</td>
		  </tr>
		  	...
		  	<tr>
					  <td nowrap class="formReq" width="30%">
								<abc:i18n property="hr.caption.annualRaiseValue"/>
								<fmt:message key="hr.caption.annualRaiseValue"/></td>
		
				<td  class="formBodControl">
					<spring:bind path="degree.anual_raise">
						  <input size="30"  type="text"	 name="${status.expression}" value="${status.value}"/> 			
					</spring:bind>
					</td>
		  </tr>
		  	<tr>
					  <td nowrap class="formReq" width="30%">
								<abc:i18n property="hr.caption.applyOvertime"/>
								<fmt:message key="hr.caption.applyOvertime"/></td>
		
				<td  class="formBodControl">
					<spring:bind path="degree.anual_raise">
						 <input type="checkbox" name="apply_overtime"  ${degree.apply_overtime == true ? ' checked':""}> 			
					</spring:bind>
					</td>
		  </tr>
