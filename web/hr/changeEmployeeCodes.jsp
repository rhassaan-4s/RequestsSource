...
<table width="90%" border="0" cellspacing="0" cellpadding="0" style="padding-right:10px ">
  ...
  <form method="post" action="<c:url value="changeEmployeeCodes.html?formType=true"/>">
		...
		<b><font color="red"><fmt:message key="hr.errors.employeeCodeExists"/> </font></b>
			...
			<tr>
				<td colspan="8" class="helpTitle"><abc:i18n
					property="hr.header.changeEmployeeCodes" /><fmt:message
					key="hr.header.changeEmployeeCodes" /></td>
			</tr>
						   ...
						   <c:forEach items="${results}" var="record" varStatus="loop">
							   <tr height=20 bgcolor="#F8F8F8">
								  ...
								  <td class="helpBod" nowrap>
								    ...
								    <td class="helpBod" nowrap>
							  <input type="text" id="newCode${loop.index }" name="newCode${loop.index }" />     
