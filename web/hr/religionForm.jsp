...
<table width="90%" border="0" cellspacing="0" cellpadding="0" style="padding-right:10px ">
   <form id="religionForm" name="religionForm" method="POST"	action="<c:url value="/hr/religionForm.html"/>">
   
   <input type="hidden"  id="religionId" name="religionId" value="${religionId }"/>
   <tr>
		<td colspan="2">
  	...
  	<table  align="center" width="66%" class="sofT" >
			<tr id="head_1_ep">
				<td class="helpTitle" colspan="2" nowrap><abc:i18n
					property="hr.header.addReligion" /><fmt:message
					key="hr.header.addReligion" /></td>
			</tr>
			
		    <tr>
		  <c:set var="check"  value=""/>
		  <c:if test="${religionId!=null && religionId!='' }">
				...
				<td class="formBodControl">
					<spring:bind path="religion.religion">
		   ...
		   <tr>
		    ...
		    <td nowrap class="formReq" width="30%">
				...
				<td class="formBodControl" width="70%">
					<spring:bind path="religion.name">
		  ...
		  <tr>
		   <td nowrap class="formReq" width="30%">
				...
				<td  class="formBodControl"  width="70%">
					<spring:bind path="religion.ename">
