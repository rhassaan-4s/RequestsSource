...
<table width="90%" border="0" cellspacing="0" cellpadding="0" style="padding-right:10px ">
   <form id="regionForm" name="regionForm" method="POST"	action="<c:url value="/hr/regionForm.html"/>">
   
   <input type="hidden"  id="hrRegionId" name="hrRegionId" value="${hrRegionId }"/>
   <tr>
		<td colspan="2">
			<spring:bind path="hrRegion.*">
  	...
  	<table  align="center" width="66%" class="sofT" >
			<tr id="head_1_ep">
				<td class="helpTitle" colspan="2" nowrap><abc:i18n
					property="hr.header.addRegion" /><fmt:message
					key="hr.header.addRegion" /></td>
			</tr>
			
		    <tr>
		  <c:set var="check"  value=""/>
		  <c:if test="${hrRegionId!=null && hrRegionId!='' }">
				...
				<td class="formBodControl">
					<spring:bind path="hrRegion.region">
		   ...
		   <tr>
		    ...
		    <td nowrap class="formReq" width="30%">
				...
				<td class="formBodControl" width="70%">
					<spring:bind path="hrRegion.name">
		  ...
		  <tr>
		   <td nowrap class="formReq" width="30%">
				...
				<td  class="formBodControl" width="70%">
					<spring:bind path="hrRegion.ename">
