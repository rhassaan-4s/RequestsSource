...
<table width="90%" border="0" cellspacing="0" cellpadding="0" style="padding-right:10px ">
   <form id="violationResultForm" name="violationResultForm" method="POST"	action="<c:url value="/hr/violationResultForm.html"/>">
   
   <input type="hidden"  id="hrViolationResultId" name="hrViolationResultId" value="${hrViolationResultId}"/>
   <tr>
		<td colspan="2">
			<spring:bind path="hrViolationResult.*">
  	...
  	<table  align="center" width="66%" class="sofT" >
			<tr id="head_1_ep">
				<td class="helpTitle" colspan="2" nowrap><abc:i18n
					property="hr.header.addViolationResult" /><fmt:message
					key="hr.header.addViolationResult" /></td>
			</tr>
			
		    <tr>
		  <c:set var="check"  value=""/>
		  <c:if test="${hrViolationResultId!=null && hrViolationResultId!='' }">
				...
				<td class="formBodControl">
					<spring:bind path="hrViolationResult.code">
		   ...
		   <tr>
		    ...
		    <td nowrap class="formReq" width="30%">
				...
				<td class="formBodControl" width="70%">
					<spring:bind path="hrViolationResult.name">
		  ...
		  <tr>
		   <td nowrap class="formReq" width="30%">
				...
				<td  class="formBodControl" width="70%">
					<spring:bind path="hrViolationResult.ename">
