									...
									<tr>
										...
										<td valign="top" >
											<tree:nodeMatch node="tree.node" hasChildren="true"
												...
												<c:choose>
													<c:when test="${result.id != null}">
														<a
															href="qualificationDivisionTree.html?expand=<tree:nodeId node="tree.node"/>&isFinancial=${isFinancial}&qualificationDivisionId=${result.id}"><img
															src="/Requests/web/gl/images/ar_collapsedMidNode.gif" border="0"></a>
													</c:when>
													<c:otherwise>
														<a
															href="qualificationDivisionTree.html?expand=<tree:nodeId node="tree.node"/>&isFinancial=${isFinancial}"><img
															src="/Requests/web/gl/images/ar_collapsedMidNode.gif" border="0"></a>
													</c:otherwise>
												</c:choose>
											</tree:nodeMatch>
											...
											<tree:nodeMatch node="tree.node"
												...
												<c:choose>
													<c:when test="${result.id != null}">
														<a
															href="qualificationDivisionTree.html?qualificationDivisionId=${result.id}&isFinancial=${isFinancial}&collapse=<tree:nodeId node="tree.node"/>"><img
															src="/Requests/web/gl/images/ar_expandedMidNode.gif" border="0"></a>
													</c:when>
													<c:otherwise>
														<a
															href="qualificationDivisionTree.html?collapse=<tree:nodeId node="tree.node"/>&isFinancial=${isFinancial}"><img
															src="/Requests/web/gl/images/ar_expandedMidNode.gif" border="0"></a>
													</c:otherwise>
												</c:choose>
											</tree:nodeMatch>
											...
											<tree:nodeMatch node="tree.node"
												...
												<c:choose>
													<c:when test="${result.id != null}">
														<a
															href="qualificationDivisionTree.html?qualificationDivisionId=${result.id}&expand=<tree:nodeId node="tree.node"/>"><img
															src="/Requests/web/gl/images/ar_collapsedLastNode.gif" border="0"></a>
													</c:when>
													<c:otherwise>
														<a
															href="qualificationDivisionTree.html?expand=<tree:nodeId node="tree.node"/>"><img
															src="/Requests/web/gl/images/ar_collapsedLastNode.gif" border="0"></a>
													</c:otherwise>
												</c:choose>
											</tree:nodeMatch>
											...
											<tree:nodeMatch node="tree.node"
												...
												<c:choose>
													<c:when test="${result.id != null}">
														<a
															href="qualificationDivisionTree.html?qualificationDivisionId=${result.id}&collapse=<tree:nodeId node="tree.node"/>"><img
										...
										<td valign="top">
											<tree:nodeMatch node="tree.node">
												&nbsp;
												<a
													href="qualificationDivisionTree.html?qualificationDivisionId=<tree:nodeId node="tree.node"/>&select=<tree:nodeId node="tree.node"/>">
				...
				<c:if test="${result.id != null}">
					...
					<tr valign="top">
							<td nowrap align="center">
									<c:if test="${qualificationDivisionId!=null ||qualificationDivisionId==''}">
										<c:choose>
											<c:when test="${result.isLast == 'true'}">
												...
												<input type="button"  
													...
													class="button"
													onclick="window.location='qualificationDivisionForm.html?parentId=${result.id}&isLeaf=true'"></input>
											</c:when>
											<c:otherwise>
												...
												<input type="button"
													value="<fmt:message key="commons.button.add"/>" name="edit"
													class="button"
													onclick="window.location='qualificationDivisionForm.html?parentId=${result.id}&isLeaf=false'"></input>
										...
										<input type="button" value="<fmt:message key="commons.button.edit"/>"
											...
											onclick="window.location='qualificationDivisionForm.html?qualificationDivisionId=${result.id}&isLeaf=${isLeaf}'"></input>

										<abc:i18n property="commons.button.delete" />
										<input
											type="button" value="<fmt:message key="commons.button.delete"/>"
											name="delete" class="button"
											onclick="window.location='qualificationDivisionTree.html?deleteId=${result.id}'"></input>
								        ...
								        <c:if test="${canCopyLeafs=='true'}">
										       <abc:i18n property="hr.button.copyLeafs" />
												<input
													...
													name="delete" class="button"
													onclick="window.location='qualificationDivisionForm.html?copyId=${result.id}'"></input>
										</c:if>
