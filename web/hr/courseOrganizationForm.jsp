...
<table width="90%" border="0" cellspacing="0" cellpadding="0" style="padding-right:10px ">
   <form id="courseOrganizationForm" name="courseOrganizationForm" method="POST"	action="<c:url value="/hr/courseOrganizationForm.html"/>">
   
   <input type="hidden"  id="courseOrganizationId" name="courseOrganizationId" value="${courseOrganizationId }"/>
   <tr>
		<td colspan="2">
			<spring:bind path="courseOrganization.*">
  	...
  	<table  align="center" width="66%" class="sofT" >
			<tr id="head_1_ep">
				<td class="helpTitle" colspan="2" nowrap><abc:i18n
					property="hr.header.addCourseOrganization" /><fmt:message
					key="hr.header.addCourseOrganization" /></td>
			</tr>
			
		    <tr>
		  <c:set var="check"  value=""/>
		  <c:if test="${courseOrganizationId!=null && courseOrganizationId!='' }">
				...
				<td class="formBodControl">
					<spring:bind path="courseOrganization.dircorse">
		   ...
		   <tr>
		    ...
		    <td nowrap class="formReq" width="30%">
				...
				<td class="formBodControl" width="70%">
					<spring:bind path="courseOrganization.name">
		  ...
		  <tr>
		   <td nowrap class="formReq" width="30%">
				...
				<td  class="formBodControl" width="70%">
					<spring:bind path="courseOrganization.ename">
