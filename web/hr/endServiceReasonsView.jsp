...
<abc:security property="45"/><br>

<table width="90%" border="0" cellspacing="0" cellpadding="0" style="padding-right:10px ">
   <form id="endServiceReasonsView" name="endServiceReasonsView" method="POST" action="<c:url value="/hr/endServiceReasonsView.html"/>">
			...
			<tr>
				<td colspan="8" class="helpTitle"><abc:i18n
					property="hr.header.endServiceReasonsView" /><fmt:message
					key="hr.header.endServiceReasonsView" /></td>
			</tr>
						   ...
						   <c:forEach items="${records}" var="record">
							   <tr height=20 bgcolor="#F8F8F8">
								  ...
								  <td class="helpBod" nowrap><abc:i18n
									...
									href="endServiceReasonsForm.html?endServiceReasonsId=${record.id}"><fmt:message
		...
		<br>
			...
			<input type="button" value="<fmt:message key="commons.button.add"/>" name="add" class="button"	onclick="window.location='endServiceReasonsForm.html'"></input>
		</td>
	</tr>
