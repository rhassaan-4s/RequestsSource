...
<table width="90%" border="0" cellspacing="0" cellpadding="0" style="padding-right:10px ">
   <form id="courseResultForm" name="courseResultForm" method="POST"	action="<c:url value="/hr/courseResultForm.html"/>">
   
   <input type="hidden"  id="courseResultId" name="courseResultId" value="${courseResultId }"/>
   <tr>
		<td colspan="2">
			<spring:bind path="courseResult.*">
  	...
  	<table  align="center" width="66%" class="sofT" >
			<tr id="head_1_ep">
				<td class="helpTitle" colspan="2" nowrap><abc:i18n
					property="hr.header.addCourseResult" /><fmt:message
					key="hr.header.addCourseResult" /></td>
			</tr>
			
		    <tr>
		  <c:set var="check"  value=""/>
		  <c:if test="${courseResultId!=null && courseResultId!='' }">
				...
				<td class="formBodControl">
					<spring:bind path="courseResult.result">
		   ...
		   <tr>
		    ...
		    <td nowrap class="formReq" width="30%">
				...
				<td class="formBodControl" width="70%">
					<spring:bind path="courseResult.name">
		  ...
		  <tr>
		   <td nowrap class="formReq" width="30%">
				...
				<td  class="formBodControl" width="70%">
					<spring:bind path="courseResult.ename">
