...
-->
	<tr>
		<td colspan="2"><spring:bind path="typesData.*">
			...
			</spring:bind> <form:form method="POST" modelAttribute="fields"
				action="/Requests/common/typesDataFormController.html">

				<table rules="all" align="center" width="70%" class="sofT">
					<tr id="head_1_ep">
						<td class="helpTitle" colspan="2" nowrap><abc:i18n
								property="commons.caption.addEdit" />
							<fmt:message key="commons.caption.addEdit" />&nbsp;${arDesc}</td>
						...
						<input type="hidden" size=20 maxlength=40 name="typeDataId"
							value="${typeDataId}"
							style="visibility: text; position: absolute;" />
					</tr>
					...
					<tr id="btn">
						<td colspan="6" align="center"><abc:i18n
