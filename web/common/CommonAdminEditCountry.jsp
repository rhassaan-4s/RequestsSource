...
<table width="90%" border="0" cellspacing="0" cellpadding="0"
	...
	<tr>
		<td colspan="2"><form:form method="POST" modelAttribute="country"
				action="/Requests/common/commonAdminEditCountry.html">
				...
				<table rules="all" align="center" width="70%" class="sofT">
					<tr id="head_1_ep">
						<td class="helpTitle" colspan="2" nowrap><abc:i18n
								property="commons.header.editCountry" />
							<fmt:message key="commons.header.editCountry" /></td>
					</tr>
					<tr>
					...
					<tr>
						<td nowrap class="formBod"><abc:i18n
								property="commons.caption.maleNationality" />
							<fmt:message key="commons.caption.maleNationality" /></td>
						<td class="formBodControl"><spring:bind
								path="country.maleNationality">
								<input type="text" size="40" name="${status.expression}"
									value="${status.value}"></input>
							</spring:bind></td>
					</tr>
					<tr>
						<td nowrap class="formBod"><abc:i18n
								property="commons.caption.femaleNationality" />
							<fmt:message key="commons.caption.femaleNationality" /></td>
						<td class="formBodControl"><spring:bind
								path="country.femaleNationality">
								<input type="text" size="40" name="${status.expression}"
									value="${status.value}"></input>
							</spring:bind></td>
					</tr>
