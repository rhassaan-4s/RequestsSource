...
<table width="90%" border="0" cellspacing="0" cellpadding="0"
	...
	<tr>
		<td class="tableHeader"><abc:i18n
				property="commons.header.editDepartment" />
			<fmt:message key="commons.header.editDepartment" /></td>
		<td align="left"></td>
	</tr>
	<tr>
	...
	<tr>
		<td colspan="2"><form:form method="POST"
				...
				action="/Requests/common/commonAdminEditDepartment.html">
				...
				<spring:bind path="department.id">
					<input type="hidden" size=20 maxlength=40 name="departmentId"
						value="${status.value}" />
				</spring:bind>
				...
				<table border=0 cellspacing=1 cellpadding=0 id="ep"
					...
					<tr>
						...
						<td><input type="checkbox" name="default" value="true"
							${department.isDefault == 'true' ? ' checked':''} /></td>
					</tr>
