...
<table width="90%"  border="0" cellspacing="0" cellpadding="0" style="padding-right:10px ">
	...
	<tr>
		<td class="tableHeader"><abc:i18n property="commons.header.editRegion"/><fmt:message key="commons.header.editRegion"/></td><td align="left"></td>
	</tr>
	<tr>
...
<tr>
	<td colspan="2">
		...
		<form 	id="region"
			name="region"
			method="POST" 
			action="<c:url value="/common/commonAdminEditRegion.html"/>">
			...
			<tr id="head_1_ep">
				<td class="bodyBold" colspan=4 nowrap><abc:i18n property="commons.header.editRegion"/><fmt:message key="commons.header.editRegion"/></td>
			...
			<tr>
				<td nowrap class="requiredInput"><abc:i18n property="commons.caption.regionCode"/><fmt:message key="commons.caption.regionCode"/></td>
				
				<td colspan="4">
					<spring:bind path="region.code">
			...
			<tr>
				<td nowrap class="requiredInput">
					<abc:i18n property="commons.caption.country" />
					 <fmt:message key="commons.caption.country" />
				</td>
				<td colspan="4">
				<spring:bind path ="region.country">
					<select name="${status.expression}" id=country onchange="changeList();">
						<option value=""><fmt:message key="commons.caption.select" /></option>
						<c:forEach items="${countries}" var="c">
							<option value="${c.id}" ${c.id == region.country.id ?' selected' : ''}>${c.description}</option>
						</c:forEach>
					</select>
				</spring:bind>
				</td>
			...
			<tr>
				<td nowrap class="requiredInput">
					<abc:i18n property="commons.caption.city" />
					 <fmt:message key="commons.caption.city" />
				</td>
				<td colspan="4">
					<select multiple size="5" name="cities" id=cities>
