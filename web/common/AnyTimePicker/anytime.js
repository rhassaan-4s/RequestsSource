...
(function($)
{
 ...
 //rana 			if ( window.location.hostname.length && ( window.location.hostname != 'www.ama3.com' ) )
 //rana 				$(document.body).append('<img src="http://www.ama3.com/anytime/ping/?4.1112A'+(AnyTime.utcLabel?".tz":"")+'" width="0" height="0" />');
