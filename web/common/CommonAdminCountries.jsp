...
<table width="90%" border="0" cellspacing="0" cellpadding="0"
	...
	<tr>
		<td class="tableHeader"><abc:i18n
			...
			key="commons.header.countries" /></td>
		<td align="left"></td>
	</tr>
	<tr>
			...
			<c:forEach var="result" items="${results}">
				<tr height=20 bgcolor="#F8F8F8">
					...
					<td class="helpBod"><NOBR>&nbsp;<abc:i18n
						...
						href="commonAdminEditCountry.html?countryId=${result.id}"
						class="actionLink"><fmt:message key="commons.button.edit" /></a>&nbsp;</NOBR>
					<NOBR>&nbsp;<abc:i18n property="commons.caption.cities" /><a
						href="commonAdminCountryCities.html?countryId=${result.id}"
						class="actionLink"><fmt:message key="commons.caption.cities" /></a>&nbsp;</NOBR>
					</td>
				</tr>
			</c:forEach>
		</table>
...
<table>
	<tr>
		<td align="center"><abc:i18n property="commons.button.add" /><input
			...
			onclick="window.location = 'commonAdminEditCountry.html';"></td>
	</tr>
</table>
