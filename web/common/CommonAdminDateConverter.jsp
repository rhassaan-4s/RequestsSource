	...
	<tr>
		...
		<tr>
			<td colspan="2"><form:form method="POST"
					modelAttribute="dateConverter"
					action="/Requests/common/commonAdminDateConverter.html">

					<table rules="all" align="center" width="70%" class="sofT">
						<tr id="head_1_ep">
							<td class="helpTitle" colspan="2" nowrap><abc:i18n
									property="commons.header.dateConverter" />
								<fmt:message key="commons.header.dateConverter" /></td>
						</tr>
						<tr>
							<td nowrap class="formReq"><abc:i18n
									property="commons.caption.date" />
						...
						<tr>
							<td nowrap class="formBod"><abc:i18n
									property="commons.caption.convertedDate" />
								<fmt:message key="commons.caption.convertedDate" /></td>
