...
<table width="90%" border="0" cellspacing="0" cellpadding="0"
	...
	<tr>
		<td colspan="2"><form:form method="POST" modelAttribute="city"
				action="/Requests/common/commonAdminEditCity.html">

				<input type="hidden" size=20 maxlength=40 name="cityId"
					value="${city.id}" />
				...
				<table rules="all" align="center" width="50%" class="sofT">
					<tr id="head_1_ep">
						<td class="helpTitle" colspan="2" nowrap><abc:i18n
								property="commons.header.editCity" />
							<fmt:message key="commons.header.editCity" /></td>
					</tr>
					<tr>
						<td nowrap class="formReq" width="30%"><abc:i18n
								property="commons.caption.countryName" />
							<fmt:message key="commons.caption.countryName" /></td>
						<td class="formBodControl">${city.country.description}</td>
					</tr>

					<tr>
						<td nowrap class="formReq"><abc:i18n
								property="commons.caption.city" />
					...
					<tr>
						<td nowrap class="formReq"><abc:i18n
								property="commons.caption.englishDescription" />
							<fmt:message key="commons.caption.englishDescription" /></td>
						<td class="formBodControl"><spring:bind
								path="city.englishDescription">
								<input type="text" size="20" name="${status.expression}"
									value="${status.value}"></input>
							</spring:bind></td>
					</tr>
					<tr>
						...
						<td class="formBodControl"><input type="checkbox"
