...
@Controller
@RequestMapping("/empReqTypeGroupForm.html")
public class EmpReqTypeGroupForm extends BaseSimpleFormController{
	...
	@Autowired
	@Qualifier("groupAccBinder")
	private DomainObjectBinder groupAccBinder;
...
//		return empReqTypeAcc;
		model.put("empReqTypeAcc", empReqTypeAcc);
		return "empReqTypeGroupForm";
	}
...
//**************************************** onBindAndValidate ***********************************************\\
	...
	public ModelAndView processSubmit(HttpServletRequest request,
			@Valid @ModelAttribute("empReqTypeAcc") EmpReqTypeAcc command,
