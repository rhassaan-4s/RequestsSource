...
public class HREmployeeJob  implements Auditable,Serializable {
	...
	@Id @GeneratedValue(strategy=GenerationType.SEQUENCE, generator="hr_employee_job_seq")
	@SequenceGenerator(name="hr_employee_job_seq",sequenceName="hr_employee_job_seq")
