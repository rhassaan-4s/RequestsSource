...
public class HREffectRoundType implements Auditable,Serializable {
	...
	@Id @GeneratedValue(strategy=GenerationType.SEQUENCE, generator="HR_effect_round_type_SEQ")
	@SequenceGenerator(name="HR_effect_round_type_SEQ",sequenceName="HR_effect_round_type_SEQ")
	private Long id;
	private String name;
