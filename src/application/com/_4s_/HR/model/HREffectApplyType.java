...
public class HREffectApplyType implements Auditable,Serializable {
	...
	@Id @GeneratedValue(strategy=GenerationType.SEQUENCE, generator="HR_effect_apply_SEQ")
	@SequenceGenerator(name="HR_effect_apply_SEQ",sequenceName="HR_effect_apply_SEQ")
	private Long id;
	private String name;
	...
	public String getEntityDisplayName() {
		return "EffectApplyType Addition";
	}
	@Override
	...
	public boolean equals(Object o) {
		 ...
		 if (!(o instanceof HREffectApplyType)) {
		 return false;
		 }
		 HREffectApplyType rhs = (HREffectApplyType) o;
