...
public class VacationDaysTransactionForm extends BaseSimpleFormController {
   ...
   //in case of editing object
     ...
     else
     {
		...
		model.addAttribute(hrEmployeeQualification);
	   return "vacationDaysTransactionForm" ;
	}
//**************************************** referenceData ***********************************************\\
	
	@ModelAttribute("model")	public Map populateWebFrameworkList(@RequestParam(value = "error", required = false) String error,
			@ModelAttribute HREmployeeQualification command,HttpServletRequest request) 
	{
