...
public class EmployeeAllocationForm extends BaseSimpleFormController {
		...
		public String initForm(ModelMap model,HttpServletRequest request){
			...
			model.addAttribute("hrEmployeeJob", hrEmployeeJob);
		   return "employeeAllocationForm";
		}
	//**************************************** referenceData ***********************************************\\
		@ModelAttribute("model")	public Map populateWebFrameworkList(@RequestParam(value = "error", required = false) String error,@ModelAttribute HREmployeeJob command,HttpServletRequest request) 
		{
