...
function getExportDialog() {
	var exportDialog =
		"<HTML>" +
		"<HEAD>" +
		"<LINK rel='stylesheet' type='text/css' href='/crystalreportviewers11/css/default.css'>" +

		"<script type='text/javascript' src='/crystalreportviewers11/js/exportdialog.js'></script>" +
