...
function addPromptRangeValue ( inForm, type , paramName )
{
    ...
    {
		display = ConstructRangeDisplayString(FROM, ldisplay, "");
    }
    else if (lowerUnBounded && upperChecked)
    {
		display = ConstructRangeDisplayString(TO, udisplay, "");
    }
    else if (!lowerChecked && upperUnBounded)
    {
		display = ConstructRangeDisplayString(AFTER, ldisplay, "");
    }
    else if (lowerUnBounded && !upperChecked)
    {
		display = ConstructRangeDisplayString(BEFORE, udisplay, "");
    }
    else if (lowerChecked  && upperChecked)
    {
		display = ConstructRangeDisplayString(FROM_TO, ldisplay, udisplay);
    }
    else if (lowerChecked && !upperUnBounded && !upperChecked)
    {
		display = ConstructRangeDisplayString(FROM_BEFORE, ldisplay, udisplay);
    }
    else if (!lowerChecked && !lowerUnBounded && upperChecked)
    {
		display = ConstructRangeDisplayString(AFTER_TO, ldisplay, udisplay);
    }
    else if (!lowerChecked && !lowerUnBounded && !upperChecked && !upperUnBounded)
    {
		display = ConstructRangeDisplayString(AFTER_BEFORE, ldisplay, udisplay);
    }
