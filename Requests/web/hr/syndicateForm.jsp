...
<table width="90%" border="0" cellspacing="0" cellpadding="0" style="padding-right:10px ">
   <form id="syndicateForm" name="syndicateForm" method="POST"	action="<c:url value="/hr/syndicateForm.html"/>">
   
   <input type="hidden"  id="syndicateId" name="syndicateId" value="${syndicateId }"/>
   <tr>
		<td colspan="2">
			<spring:bind path="syndicate.*">
  	...
  	<table  align="center" width="66%" class="sofT" >
			<tr id="head_1_ep">
				<td class="helpTitle" colspan="2" nowrap><abc:i18n
					property="hr.header.addSyndicate" /><fmt:message
					key="hr.header.addSyndicate" /></td>
			</tr>
			
		    <tr>
		  <c:set var="check"  value=""/>
		  <c:if test="${syndicateId!=null && syndicateId!='' }">
				...
				<td class="formBodControl">
					<spring:bind path="syndicate.code">
		   ...
		   <tr>
		    ...
		    <td nowrap class="formReq" width="30%">
				...
				<td class="formBodControl" width="70%">
					<spring:bind path="syndicate.name">
		  ...
		  <tr>
		   <td nowrap class="formReq" width="30%">
				...
				<td  class="formBodControl"  width="70%">
					<spring:bind path="syndicate.ename">
