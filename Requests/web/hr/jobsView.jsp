...
<table width="90%" border="0" cellspacing="0" cellpadding="0" style="padding-right:10px ">
   <form id="jobsView" name="jobsView" method="POST" action="<c:url value="/hr/jobsView.html"/>">
			...
			<tr>
				<td colspan="8" class="helpTitle"><abc:i18n
					property="hr.header.titlesView" /><fmt:message
					key="hr.header.titlesView" /></td>
			</tr>
						   ...
						   <c:forEach items="${records}" var="record">
							   <tr height=20 bgcolor="#F8F8F8">
								  ...
								  <td class="helpBod" nowrap><abc:i18n
									...
									href="jobForm.html?jobId=${record.id}"><fmt:message
		...
		<br>
			...
			<input type="button" value="<fmt:message key="commons.button.add"/>" name="add" class="button"	onclick="window.location='jobForm.html'"></input>
		</td>
	</tr>
