...
<table width="90%" border="0" cellspacing="0" cellpadding="0"
	...
	<tr>
		...
		<fmt:message
			key="hr.header.specialtyDivisionCodes" />
			</td>
			</tr>
				<tr>
					<td>
				...
				<tr>
					...
					<td colspan="2">
					<form id="certificate" name="certificate" method="POST"	action="<c:url value="/hr/coursesLevelForm.html"/>" onLoad="return init();">
						<spring:bind path="specialtyLevelCommand.*">
				...
				<TABLE id="table1" cellpadding="0" cellspacing="0" border="0" width="100%">
						...
						<c:forEach var="lvl" items="${specialtyLevelCommand.levels}"
							varStatus="loop">
