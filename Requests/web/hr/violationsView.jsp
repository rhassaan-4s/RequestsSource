...
<table width="90%" border="0" cellspacing="0" cellpadding="0" style="padding-right:10px ">
   <form id="violationsView" name="violationsView" method="POST" action="<c:url value="/hr/violationsView.html"/>">
			...
			<tr>
				<td colspan="8" class="helpTitle"><abc:i18n
					property="hr.header.violationsView" /><fmt:message
					key="hr.header.violationsView" /></td>
			</tr>
						   ...
						   <c:forEach items="${records}" var="record">
							   <tr height=20 bgcolor="#F8F8F8">
								  ...
								  <td class="helpBod" nowrap><abc:i18n
									...
									href="violationForm.html?violationId=${record.id}"><fmt:message
									key="commons.button.edit" /></a></td>
									
									 <td class="helpBod" nowrap><abc:i18n
									property="commons.button.delete" /><a
									href="violationsView.html?deleteId=${record.id}"><fmt:message
		...
		<br>
			...
			<input type="button" value="<fmt:message key="commons.button.add"/>" name="add" class="button"	onclick="window.location='violationForm.html'"></input>
		</td>
	</tr>
