...
<table width="90%" border="0" cellspacing="0" cellpadding="0" style="padding-right:10px ">
   <form id="centerForm" name="centerForm" method="POST"	action="<c:url value="/hr/centerForm.html"/>">
  	...
  	<table  align="center" width="66%" class="sofT" >
			<tr id="head_1_ep">
				<td class="helpTitle" colspan="2" nowrap><abc:i18n
					property="hr.header.addCenter" /><fmt:message
					key="hr.header.addCenter" /></td>
			</tr>
			
		    <tr>
		  <c:set var="check"  value=""/>
		  <c:if test="${centerId!=null && centerId!='' }">
				...
				<td class="formBodControl">
					<spring:bind path="center.center">
