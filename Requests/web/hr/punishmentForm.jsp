...
<table width="90%" border="0" cellspacing="0" cellpadding="0" style="padding-right:10px ">
   <form id="punishmentForm" name="punishmentForm" method="POST"	action="<c:url value="/hr/punishmentForm.html"/>">
   
   <input type="hidden"  id="punishmentId" name="punishmentId" value="${punishmentId}"/>
   <tr>
		<td colspan="2">
			<spring:bind path="punishment.*">
  	...
  	<table  align="center" width="66%" class="sofT" >
			<tr id="head_1_ep">
				<td class="helpTitle" colspan="2" nowrap><abc:i18n
					property="hr.header.addpunishment" /><fmt:message
					key="hr.header.addPunishment" /></td>
			</tr>
			
		    <tr>
		  
		  <c:set var="check"  value=""/>
		  <c:if test="${punishmentId!=null && punishmentId!=''}">
				...
				<td class="formBodControl">
					<spring:bind path="punishment.punch">
						<input size="8" maxlength="2" type="text"	name="${status.expression}" value="${status.value}" onchange="fillCode(this);"  ${check}" readonly="readonly"/> 			
					</spring:bind>
					</td>
		  </tr>
		   ...
		   <tr>
		    ...
		    <td nowrap class="formReq" width="30%">
				...
				<td class="formBodControl" width="70%">
					<spring:bind path="punishment.name">
		  ...
		  <tr>
		   <td nowrap class="formReq" width="30%">
				...
				<td  class="formBodControl" width="70%">
					<spring:bind path="punishment.ename">
