...
<table width="90%" border="0" cellspacing="0" cellpadding="0" style="padding-right:10px ">
   <form id="courseForm" name="courseForm" method="POST"	action="<c:url value="/hr/courseForm.html"/>">
  	...
  	<table  align="center" width="66%" class="sofT" >
			<tr id="head_1_ep">
				<td class="helpTitle" colspan="2" nowrap><abc:i18n
					property="hr.header.addCourse" /><fmt:message
					key="hr.header.addCourse" /></td>
			</tr>
			
		    <tr>
		  <c:set var="check"  value=""/>
		  <c:if test="${courseId!=null && courseId!='' }">
				...
				<td class="formBodControl">
					<spring:bind path="course.course">
