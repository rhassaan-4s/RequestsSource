...
<table width="90%" border="0" cellspacing="0" cellpadding="0" style="padding-right:10px ">
   <form id="sectorForm" name="sectorForm" method="POST"	action="<c:url value="/hr/sectorForm.html"/>">
   
   <input type="hidden"  id="sectorId" name="sectorId" value="${sectorId }"/>
   <tr>
		<td colspan="2">
  	...
  	<table  align="center" width="66%" class="sofT" >
			<tr id="head_1_ep">
				<td class="helpTitle" colspan="2" nowrap><abc:i18n
					property="hr.header.addSector" /><fmt:message
					key="hr.header.addSector" /></td>
			</tr>
			
		    <tr>
		  <c:set var="check"  value=""/>
		  <c:if test="${sectorId!=null && sectorId!='' }">
				...
				<td class="formBodControl">
					<spring:bind path="sector.sector">
