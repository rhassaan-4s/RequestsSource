...
<table width="90%" border="0" cellspacing="0" cellpadding="0" style="padding-right:10px ">
   <form id="schoolForm" name="schoolForm" method="POST"	action="<c:url value="/hr/schoolForm.html"/>">
  	...
  	<table  align="center" width="66%" class="sofT" >
			<tr id="head_1_ep">
				<td class="helpTitle" colspan="2" nowrap><abc:i18n
					property="hr.header.addSchool" /><fmt:message
					key="hr.header.addSchool" /></td>
			</tr>
		  ...
		  <c:if test="${schoolId!=null && schoolId!='' }">
				...
				<td class="formBodControl">
					<spring:bind path="school.school">
