...
<table width="90%" border="0" cellspacing="0" cellpadding="0" style="padding-right:10px ">
   <form id="courseSpecialtyForm" name="courseSpecialtyForm" method="POST"	action="<c:url value="/hr/courseSpecialtyForm.html"/>">
   
   <input type="hidden"  id="courseSpecialtyId" name="courseSpecialtyId" value="${courseSpecialtyId }"/>
   <tr>
		<td colspan="2">
			<spring:bind path="courseSpecialty.*">
  	...
  	<table  align="center" width="66%" class="sofT" >
			<tr id="head_1_ep">
				<td class="helpTitle" colspan="2" nowrap><abc:i18n
					property="hr.header.addCourseSpecialty" /><fmt:message
					key="hr.header.addCourseSpecialty" /></td>
			</tr>
			
		    <tr>
		  <c:set var="check"  value=""/>
		  <c:if test="${courseSpecialtyId!=null && courseSpecialtyId!='' }">
				...
				<td class="formBodControl">
					<spring:bind path="courseSpecialty.special">
		   ...
		   <tr>
		    ...
		    <td nowrap class="formReq" width="30%">
				...
				<td class="formBodControl" width="70%">
					<spring:bind path="courseSpecialty.name">
		  ...
		  <tr>
		   <td nowrap class="formReq" width="30%">
				...
				<td  class="formBodControl" width="70%">
					<spring:bind path="courseSpecialty.ename">
