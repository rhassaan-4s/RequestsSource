		...
		<fmt:message
			key="hr.header.qualificationDivisionTree" />
				...
				<tr>
					...
					<td colspan="2">
					<form id="certificate" name="certificate" method="POST"	action="<c:url value="/hr/qualificationLevelForm.html"/>" onLoad="return init();">
						<spring:bind path="qualificationLevelCommand.*">
				...
				<TABLE id="table1" cellpadding="0" cellspacing="0" border="0" width="100%">
						...
						<c:forEach var="lvl" items="${qualificationLevelCommand.levels}"
							varStatus="loop">
