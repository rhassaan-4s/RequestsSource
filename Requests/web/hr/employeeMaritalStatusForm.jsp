...
<form id="empMaritalStatus" name="empMaritalStatus" method="POST"	action="<c:url value="employeeMaritalStatusForm.html"/>" >
...
<input type="hidden"  id="empMaritalStatusId" name="empMaritalStatusId" value="${empMaritalStatusId }"/>
<tr>
		<td colspan="2">
			<spring:bind path="hrEmployeeMaritalStatus.*">
...
<tr>
    	...
    	<tr height="20">
	      ...
	      <td class="helpTitle" colspan="2">
	          <b> <fmt:message	key="hr.header.employeeMaritalStatusForm" /> </b> 
	      </td>
		</tr>
		...
		<tr>
		 <td nowrap="nowrap" class="formReq">
			  <b> <fmt:message	key="hr.caption.maritalStatus" /> </b> 
		 </td>
		 <td class="formBodControl">
		 
		   <spring:bind path="hrEmployeeMaritalStatus.maritalStatus">
					...
					<option value=""><abc:i18n property="commons.caption.select"/><fmt:message key="commons.caption.select"/></option>
					 ...
					 <option value="${maritalStatus.id }" ${maritalStatus.id == hrEmployeeMaritalStatus.maritalStatus.id ? 'selected' :'' }>
					 ${ maritalStatus.name}
					  </option>
					 </c:forEach>
					...
					<tr>
					   ...
					   <td class="formBodControl">
					     <spring:bind path="hrEmployeeMaritalStatus.statusDate">
