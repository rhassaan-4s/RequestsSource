...
<table width="90%" border="0" cellspacing="0" cellpadding="0" style="padding-right:10px ">
   <form id="locationForm" name="locationForm" method="POST"	action="<c:url value="/hr/locationForm.html"/>">
  	...
  	<table  align="center" width="66%" class="sofT" >
			<tr id="head_1_ep">
				<td class="helpTitle" colspan="2" nowrap><abc:i18n
					property="hr.header.addLocation" /><fmt:message
					key="hr.header.addLocation" /></td>
			</tr>
			
		    <tr>
		  <c:set var="check"  value=""/>
		  <c:if test="${locationId!=null && locationId!='' }">
				...
				<td class="formBodControl">
					<spring:bind path="location.location">
		  ...
		  <tr>
		   <td nowrap class="formReq" width="30%">
				...
				<td  class="formBodControl" width="70%">
					<spring:bind path="location.ename">
