...
<table width="90%" border="0" cellspacing="0" cellpadding="0" style="padding-right:10px ">
   <form id="functionalGroupForm" name="functionalGroupForm" method="POST"	action="<c:url value="/hr/functionalGroupForm.html"/>">
   
   <input type="hidden"  id="hrFunctionalGroupId" name="hrFunctionalGroupId" value="${hrFunctionalGroupId }"/>
   <tr>
		<td colspan="2">
			<spring:bind path="hrFunctionalGroup.*">
  	...
  	<table  align="center" width="66%" class="sofT" >
			<tr id="head_1_ep">
				<td class="helpTitle" colspan="2" nowrap><abc:i18n
					property="hr.header.addFunctionalGroup" /><fmt:message
					key="hr.header.addFunctionalGroup" /></td>
			</tr>
			
		    <tr>
		  <c:set var="check"  value=""/>
		 
		  <c:if test="${hrFunctionalGroupId!=null && hrFunctionalGroupId!='' }">
				...
				<td class="formBodControl">
					<spring:bind path="hrFunctionalGroup.code">
		   ...
		   <tr>
		    ...
		    <td nowrap class="formReq" width="30%">
				...
				<td class="formBodControl" width="70%">
					<spring:bind path="hrFunctionalGroup.name">
		  ...
		  <tr>
		   <td nowrap class="formReq" width="30%">
				...
				<td  class="formBodControl" width="70%">
					<spring:bind path="hrFunctionalGroup.ename">
