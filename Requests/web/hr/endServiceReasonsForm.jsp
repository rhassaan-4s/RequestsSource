...
<table width="90%" border="0" cellspacing="0" cellpadding="0" style="padding-right:10px ">
   <form id="endServiceReasonsForm" name="endServiceReasonsForm" method="POST"	action="<c:url value="/hr/endServiceReasonsForm.html"/>">
   
   <input type="hidden"  id="endServiceReasonsId" name="endServiceReasonsId" value="${endServiceReasonsId}"/>
   <tr>
		<td colspan="2">
			<spring:bind path="endServiceReasons.*">
  	...
  	<table  align="center" width="66%" class="sofT" >
			<tr id="head_1_ep">
				<td class="helpTitle" colspan="2" nowrap><abc:i18n
					property="hr.header.addEndServiceReason" /><fmt:message
					key="hr.header.addEndServiceReason" /></td>
			</tr>
			
		    <tr>
		  
		  <c:set var="check"  value=""/>
		  <c:if test="${endServiceReasonsId!=null && endServiceReasonsId!=''}">
				...
				<td class="formBodControl">
					<spring:bind path="endServiceReasons.code">
						<input size="8" maxlength="6" type="text"	name="${status.expression}" value="${status.value}"  onchange="fillCode(this);"  ${check}" readonly="readonly"/> 			
					</spring:bind>
					</td>
		  </tr>
		   ...
		   <tr>
		    ...
		    <td nowrap class="formReq" width="30%">
				...
				<td class="formBodControl" width="70%">
					<spring:bind path="endServiceReasons.aname">
		  ...
		  <tr>
		   <td nowrap class="formReq" width="30%">
				...
				<td  class="formBodControl" width="70%">
					<spring:bind path="endServiceReasons.ename">
		   ...
		   <tr>
		   <td nowrap class="formReq" width="30%">
								<abc:i18n property="hr.caption.proportionFromEndOfServiceBonus"/>
								<fmt:message key="hr.caption.proportionFromEndOfServiceBonus"/></td>
			
				<td  class="formBodControl" width="70%">
					<spring:bind path="endServiceReasons.reward_ratio">
					 <input size="40"  type="text"	name="${status.expression}" value="100.00"/> 				
					</spring:bind>
					</td>
		  </tr>
