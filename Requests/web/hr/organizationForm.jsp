...
<table width="90%" border="0" cellspacing="0" cellpadding="0" style="padding-right:10px ">
   <form id="organizationForm" name="organizationForm" method="POST"	action="<c:url value="/hr/organizationForm.html"/>">
  	...
  	<table  align="center" width="66%" class="sofT" >
			<tr id="head_1_ep">
				<td class="helpTitle" colspan="2" nowrap><abc:i18n
					property="hr.header.addOrganization" /><fmt:message
					key="hr.header.addOrganization" /></td>
			</tr>
		  ...
		  <tr>
		   <td nowrap class="formReq" width="30%">
				...
				<td  class="formBodControl"  width="70%">
					<spring:bind path="organization.ename">
		 ...
		 <tr>
		   <td nowrap class="formReq" width="30%">
								...
								<fmt:message key="commons.caption.shortName"/></td>
			
				<td  class="formBodControl"  width="70%">
					<spring:bind path="organization.shortName">
					 <input size="51"  type="text"	dir="ltr" name="${status.expression}" value="${status.value}"/> 				
					</spring:bind>
					</td>
		  </tr>
