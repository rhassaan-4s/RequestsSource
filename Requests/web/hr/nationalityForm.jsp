...
<table width="90%" border="0" cellspacing="0" cellpadding="0" style="padding-right:10px ">
   <form id="nationalityForm" name="nationalityForm" method="POST"	action="<c:url value="/hr/nationalityForm.html"/>">
   
   <input type="hidden"  id="nationalityId" name="nationalityId" value="${nationalityId }"/>
   <tr>
		<td colspan="2">
  	...
  	<table  align="center" width="66%" class="sofT" >
			<tr id="head_1_ep">
				<td class="helpTitle" colspan="2" nowrap><abc:i18n
					property="hr.header.addNationality" /><fmt:message
					key="hr.header.addNationality" /></td>
			</tr>
			
		    <tr>
		  <c:set var="check"  value=""/>
		  <c:if test="${nationalityId!=null && nationalityId!='' }">
				...
				<td class="formBodControl">
					<spring:bind path="nationality.nationality_code">
						<input size="8" maxlength="5" type="text"	name="${status.expression}" value="${status.value}" onchange="fillCode(this);"  ${check}"/> 			
					</spring:bind>
					</td>
		   ...
		   <tr>
		    ...
		    <td nowrap class="formReq" width="30%">
				...
				<td class="formBodControl" width="70%">
					<spring:bind path="nationality.name">
		  ...
		  <tr>
		   <td nowrap class="formReq" width="30%">
				...
				<td  class="formBodControl" width="70%">
					<spring:bind path="nationality.ename">
