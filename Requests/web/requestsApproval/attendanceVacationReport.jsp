...
<table width="90%"  border="0" cellspacing="0" cellpadding="0" style="padding-right:10px ">
	...
	<tr>
		<td class="tableHeader"><abc:i18n property="requestsApproval.header.attendanceVacationReport"/><fmt:message key="requestsApproval.header.attendanceVacationReport"/></td><td align="left"></td>
	</tr>
	<tr>
	...
	<tr>
		<td>
			<form id="attendanceVacationReport" name="attendanceVacationReport"	method="POST" action="<c:url value="/requestsApproval/attendanceVacationReport.html"/>">
				  	<div id="result">				
					<table border=0 cellspacing=1 cellpadding=0 id="ep" style="margin-right:40px">
						<tr id="head_1_ep">
							<td class="bodyBold" colspan=4 nowrap>
							<abc:i18n property="requestsApproval.header.attendanceVacationReport"/><fmt:message key="requestsApproval.header.attendanceVacationReport"/></td>
						</tr>
