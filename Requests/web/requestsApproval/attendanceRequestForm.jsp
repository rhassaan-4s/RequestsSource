...
<table width="90%"  border="0" cellspacing="0" cellpadding="0" style="padding-right:10px ">
	...
	<tr>
		<td class="tableHeader"><abc:i18n property="requestsApproval.header.AttendanceRequest"/><fmt:message key="requestsApproval.header.AttendanceRequest"/></td><td align="left"></td>
	</tr>
	<tr>
			...
			<form id="attendanceRequestForm" name="attendanceRequestForm"	method="POST" action="<c:url value="/requestsApproval/attendanceRequestForm.html"/>">
					...
					<table border=0 cellspacing=1 cellpadding=0 id="ep" style="margin-right:40px">
						<tr id="head_1_ep">
							...
							<abc:i18n property="requestsApproval.header.AttendanceRequest"/><fmt:message key="requestsApproval.header.AttendanceRequest"/></td>
...
-->																
						...
						<tr>
					  		<td nowrap class="formReq" >
								<abc:i18n property="requestsApproval.caption.requestReason"/>
								<fmt:message key="requestsApproval.caption.requestReason"/>
							</td>
							<td  class="formBodControl" >
