...
public class EmployeeBinder extends PropertyEditorSupport implements BaseBinder{
	...
	public String getAsText() {
		...
		Employee master = ((Employee) getValue());
		String id = null;
		String text = "";
		if (master != null) {
	...
	public void setAsText(String text) throws IllegalArgumentException {
		...
		if ((text != null) && (text.length() > 0)) {
			log.debug(">>>>>>>>>>>>text " + text);
			Employee master = (Employee) baseManager
					.getObjectByParameter(Employee.class,"empCode", text.replace(",", ""));
